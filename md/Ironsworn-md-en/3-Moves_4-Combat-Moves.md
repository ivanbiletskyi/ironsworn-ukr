...
As with the *Strike* move, each point of harm you inflict is marked on your foe’s progress track, as appropriate to their rank [page 134](5-Foes-and-Encounters_1-NPCs-in-the-Ironlands.md#npcs-in-the-ironlands).
...
Chapter 6 includes the Combat Action oracle [page 188](6-Oracles_2-Ironland-Oracles.md#oracle-16-combat-action) which you can use to prompt an NPC action or response in a fight. You can also leverage the description of your foe’s tactics in chapter 5 [page 133](4-Your-World_3-Your-Truths.md#horrors) to guide their behavior.
