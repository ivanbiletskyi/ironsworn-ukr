...
*   When you **Swear an Iron Vow** [page 98](3-Moves_6-Quest-Moves.md), a progress track represents the challenges you overcome on your way to achieving your ultimate goal.
*   When you **Undertake a Journey** [page 65](3-Moves_2-Adventure-Moves.md#undertake-a-journey), a progress track represents how far you’ve gone and how favorable the travel has been.
*   When you **Enter the Fray** [page 78](3-Moves_4-Combat-Moves.md), a progress track represents your advantage as you weaken or wound your foes in combat.
*   When you establish a new relationship with a character in your world and **Forge a Bond** [p. 74](3-Moves_3-Relationship-Moves.md#forge-a-bond), you mark progress on your bonds progress track.
...
Similarly, when you fight, you *Strike* [page 79](3-Moves_4-Combat-Moves.md#strike) or *Clash* [page 80](3-Moves_4-Combat-Moves.md#clash) to inflict harm on your foe. To move forward in your quest, you use the *Reach a Milestone* move [page 100](3-Moves_6-Quest-Moves.md#reach-a-milestone). These incremental moves let you amass advantages to have the best chance of success when you are ready to resolve your challenge.
...
If you are marking progress on your bonds progress track, you always mark 1 tick unless a move tells you otherwise. Bonds are not given a challenge rank. To learn more about bonds, see [page 24](1-Basics_10-Bonds.md#bonds).

---

## PROGRESS MOVES
There are four moves, called **progress moves**, which utilize progress tracks to resolve the outcome of a goal or challenge.
*   To resolve a quest, ***Fulfill Your Vow*** [page 101](3-Moves_6-Quest-Moves.md#fulfill-your-vow).
*   To end your journey, ***Reach Your Destination*** [page 68](3-Moves_2-Adventure-Moves.md#reach-your-destination).
*   To decide the outcome of combat, ***End the Fight*** [page 82](3-Moves_4-Combat-Moves.md#end-the-fight).
*   When you retire from your life as Ironsworn, ***Write Your Epilogue*** [page 77](3-Moves_3-Relationship-Moves.md#write-your-epilogue).

> ### REACH YOUR DESTINATION (Progress Move)
