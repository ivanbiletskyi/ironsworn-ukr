...
```text
      ...
      \   /           \   /         \   /           \   /
       \ /             \ /           \ /             \ /
   One of your oracle dice     You can also use two D10s of
   may include tens digits     different colors, and decide
   on its faces. If so,        before rolling which represents
   you’d read this result      the tens digit and which is the
   as 83.                      units. You’d read this result
                               as 36.
```
...
## MORE RANDOMNESS
You’ll find a set of random tables in chapter 6 [page 165](6-Oracles_1-Seeking-Inspiration.md). These provide inspirational prompts and random results for common situations. You can also use whatever random generators you prefer, including those drawn from another game, online generators, or visual tools such as tarot cards.
