...
```text
      ...
      \   /           \   /          +---+
       \ /             \ /
   CHALLENGE DICE (d10)           ACTION DIE (d6)
```
...
## GM’S AND THE DICE
If you are playing as a GM, you can focus on guiding the game and responding to your player’s questions and actions. Since NPCs don’t make moves, you won’t need to make action rolls. However, you might want to have a pair of d10’s available for oracle rolls [page 22](1-Basics_9-Oracles.md#oracles).
