...
*   **When you face physical damage**, make the *Endure Harm* move [page 91](3-Moves_5-Suffer-Moves.md#endure-harm).
*   **When you score a miss on the *Endure Harm* move, and your health is at 0**, you may need to *Face Death* [page 93](3-Moves_5-Suffer-Moves.md#face-death).
*   **When your companion is exposed to harm**, make the *Companion Endure Harm* move [page 94](3-Moves_5-Suffer-Moves.md#companion-endure-harm).
*   **When you are demoralized, afraid, or acting against your best intentions**, make the *Endure Stress* move [page 95](3-Moves_5-Suffer-Moves.md#endure-stress).
*   **When you score a miss on the *Endure Stress* move, and your spirit is at 0**, you may need to *Face Desolation* [page 96](3-Moves_5-Suffer-Moves.md#face-desolation).
*   **When your supply falls to 0**, all characters make the *Out of Supply* move [page 97](3-Moves_5-Suffer-Moves.md#out-of-supply). If you are at 0 supply and suffer additional -supply, you each need to reduce your health, spirit, or momentum tracks by that amount.
*   **When your momentum track is at its minimum (-6), and you suffer additional -momentum**, make the *Face a Setback* [page 97](3-Moves_5-Suffer-Moves.md#out-of-supply) move.
...
If you face an attack by an NPC foe, you use their rank [page 134](5-Foes-and-Encounters_1-NPCs-in-the-Ironlands.md#npcs-in-the-ironlands) to determine the amount of harm dealt. If the amount of harm is not indicated or obvious, use the following guidelines.
...
If you are demoralized or frightened by an NPC foe, you can use their rank [page 134](5-Foes-and-Encounters_1-NPCs-in-the-Ironlands.md#npcs-in-the-ironlands) to determine amount of stress you must suffer. If the amount of stress is not provided or obvious, use the following guidelines.
