...
## THE FLOW OF PLAY (FLOWCHART)

```mermaid
graph TD
    START((START)) --> Envision[Envision the current situation<br/>and what your character is doing.]
    Envision <--> Questions[Ask and answer questions about<br/>the world, other characters, and<br/>what happens next<br/><i>or Ask the Oracle</i>]
    Envision --> MoveTrigger{When your action or the<br/>current situation triggers a<br/>move, make that move.}
    Questions --> MoveTrigger
    MoveTrigger --> StrongHit[<b>STRONG HIT</b><br/>You've succeeded.<br/>You are in control.]
    MoveTrigger --> WeakHit[<b>WEAK HIT</b><br/>You've made progress,<br/>but aren't in control.]
    MoveTrigger --> Miss[<b>MISS</b><br/>You've failed, or<br/>encounter a costly<br/>turn of events.]
    StrongHit --> NextAction[What do you do next?]
    WeakHit --> NextEvent[What happens next?]
    Miss --> NextEvent
    NextAction --> Envision
    NextEvent --> Envision
```
