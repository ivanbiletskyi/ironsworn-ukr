...
To learn more about how the mechanics and fiction interact, see [page 203](file:///Users/ivanbiletskyi/Documents/Ivan/D&D/books/Ironsworn/Ironsworn-md/7-Gameplay-in-Depth_2-The-Mechanics-and-the-Fiction.md).

## THE SETTING
The default setting for your adventures is the **Ironlands**. It is a rugged peninsula of isolated communities and untracked wilds on the frontier of the known world. You can learn more about the setting starting on [page 111](file:///Users/ivanbiletskyi/Documents/Ivan/D&D/books/Ironsworn/Ironsworn-md/4-Your-World_1-Welcome-to-the-Ironlands.md). For now, here’s a summary of some default assumptions.
...
With a bit of work, you can even adapt these rules to different genres. See [page 237](file:///Users/ivanbiletskyi/Documents/Ivan/D&D/books/Ironsworn/Ironsworn-md/7-Gameplay-in-Depth_6-Hacking-Ironsworn.md) for more on hacking *Ironsworn*.
...
To learn more about creating your character and the components that make up your character, see [page 31](file:///Users/ivanbiletskyi/Documents/Ivan/D&D/books/Ironsworn/Ironsworn-md/2-Your-Character.md).

### THE CHARACTER SHEET

| SECTION | DESCRIPTION |
| :--- | :--- |
| **VOWS** | Your **vows** [page 35](2-Your-Character_2-Character-Basics.md#momentum) are your sacred oaths to complete perilous quests. Each vow has a **rank** and is managed through a **progress track**. |
| **STATS** | You have five **stats** [page 33](2-Your-Character_2-Character-Basics.md) which represent the core aspects of your character. These are often added as a bonus when you take action. |
| **EXPERIENCE** | As you fulfill vows, you earn **experience** [page 44](2-Your-Character_6-Assets.md#failing-an-asset-move). You spend experience to gain new assets. |
| **MOMENTUM** | As you take action, you build or lose **momentum** [page 11](1-Basics_4-Momentum.md). Positive momentum can help improve the result of an action. Negative momentum can undermine an otherwise successful action. |
| **DEBILITIES** | You suffer **debilities** [page 36](2-Your-Character_4-Bonds.md) as you face harrowing challenges. Some debilities are temporary and easily mended; others are permanent. |
| **STATUS TRACKS** | You have status tracks for **health**, **spirit**, and **supply** [page 33](2-Your-Character_2-Character-Basics.md). These represent your current condition and readiness. |
...
+-------+-------+-------+--------+-------+--------------------+
|  +10  |       |       |       |        |       |   HEALTH   |
|  +9   | EDGE  | HEART | IRON  | SHADOW | WITS  |     +5     |
|  +8   |       |       |       |        |       |     +4     |
|  +7   +-------+-------+   O   +--------+-------+     +3     |
|  +6   |                                        |     +2     |
|  +5   |                 BONDS                  |     +1     |
...
|  +3   |                                        |------------|
|  +2   |                  VOWS                  |   SPIRIT   |
|  +1   |   O TROUBLESOME O DANGEROUS O FORMIDABLE |     +5     |
|   0   |   [ ][ ][ ][ ][ ][ ][ ][ ][ ][ ]       |     +4     |
|  -1   |                                        |     +3     |
|  -2   |   O TROUBLESOME O DANGEROUS O FORMIDABLE |     +2     |
|  -3   |   [ ][ ][ ][ ][ ][ ][ ][ ][ ][ ]       |     +1     |
|  -4   |                                        |      0     |
|  -5   |               DEBILITIES               |------------|
|  -6   |  CONDITIONS           BANES            |   SUPPLY   |
|  MAX  |  O WOUNDED            O MAIMED         |     +5     |
|       |  O SHAKEN             O CORRUPTED      |     +4     |
| RESET |  O UNPREPARED         BURDENS          |     +3     |
|       |  O ENCUMBERED         O CURSED         |     +2     |
|   M   |                       O TORMENTED      |     +1     |
|   O   |       _..._                            |      0     |
|   M   |      /     \    IRONSWORN              |   S  |     |
|   E   |     |  / \  |                          |   T  |     |
