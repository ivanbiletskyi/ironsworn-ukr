...
Among the choices provided in the *Ask the Oracle* move is “spark an idea” [page 107](3-Moves_7-Fate-Moves.md#ask-the-oracle). You can use this option (instead of or in addition to the yes/no table) to answer open-ended questions or inspire new situations.

Rolling a match on a move [page 9](1-Basics_3-The-Action-Roll.md#matches) can also trigger opportunities to introduce narrative complications and surprises through random prompts.
...
> [!TIP]
> You score a miss on your *Undertake a Journey* move, and roll “A new danger or foe is revealed” on the *Pay the Price* table [page 105](3-Moves_7-Fate-Moves.md#pay-the-price). You’re not sure what this means in the context of your current journey, and decide to spark an idea to see what happens. You roll on the Action and Theme tables [page 174](6-Oracles_2-Ironland-Oracles.md#oracle-1-action), and the oracle answers, “Bolster vengeance.” Playing off this prompt, you decide it would be interesting to bring back a particular enemy, one who holds a grudge against you. They’ve gathered allies and are tracking you on your journey.

---

## ORACLES IN GUIDED PLAY

GM’s can use oracles for support during play and to supplement their narrative decision-making. Mundane oracles, such as names [page 184](6-Oracles_2-Ironland-Oracles.md#oracle-12-character-descriptor), are helpful to quickly flesh out details. Interpretative oracles, such as the Action and Theme tables [page 174](6-Oracles_2-Ironland-Oracles.md#oracle-1-action), can be used to spark new ideas.

> [!TIP]
> When the characters *Sojourn* at a small settlement deep in the Flooded Lands, they roll a match. Everyone is interested in using that match to drive a new quest. The GM rolls on the Settlement Trouble table [page 181](6-Oracles_2-Ironland-Oracles.md#oracle-9-settlement-trouble). The oracle answers, “Production halts.”
>
...
![A mystic in a dark cloak standing on a rocky shore](/Users/ivanbiletskyi/Documents/Ivan/D&D/books/Ironsworn/Ironsworn-Rulebook-imgs/Ironsworn-Rulebook_page-0177.jpg)
