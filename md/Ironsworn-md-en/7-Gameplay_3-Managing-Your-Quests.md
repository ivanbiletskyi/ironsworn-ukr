...
> 
> Perhaps you stumble across Blood Moon clan raiders, war-kin from your former life, and they have something to do with the plot against the overseer.
> 
...
```mermaid
graph TD
    A[Swear an Iron Vow] --> B[Envision your next steps and the<br/>challenges you face.<br/>Play to see what happens.]
    B --> C[You face a crucial challenge<br/>related to your quest. Do you<br/>overcome it?]
    C -- YES --> D[Reach a Milestone and<br/>mark progress.]
    C -- NO --> E[Will this quest<br/>continue?]
    E -- YES --> B
    E -- NO --> F[Forsake Your<br/>Vow]
    D --> G[Is your vow ready<br/>to be fulfilled?]
    G -- NO --> B
    G -- YES --> H[Fulfill Your Vow<br/>and mark<br/>experience.]
    H --> I[When you're ready, Advance to<br/>spend your experience on new<br/>and upgraded assets.]
```
