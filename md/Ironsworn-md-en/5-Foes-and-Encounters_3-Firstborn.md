...
| :--- | :--- |
| **Features** | Large, luminous eyes seen through a wooden mask, Gray-green skin the texture of dry leaves, Sonorous voice, Wielding bow and spear |
...
> [!NOTE]
> **YOUR TRUTH:** Elves conceal their faces behind ornate wooden masks. What do these masks signify?
...
| :--- | :--- |
| **Features** | Dark hair and ruddy skin, Twice the size of a tall human (or more), Wearing layers of wool, hide, and furs, Stoic and observant |
| **Drives** | Survive the winter, Protect the herd |
| **Tactics** | Fight as a last resort, Sweeping strike, Make them flee |
...
| **Rank** | Extreme (2 ticks per harm; inflicts 4 harm) |
| :--- | :--- |
| **Features** | Personification of the natural world, Turbulent, changing visage, Vaguely human-like or animal-like form |
...
| **Rank** | Dangerous (2 progress per harm; inflicts 2 harm) |
| :--- | :--- |
| **Features** | Yellow eyes shining in moonlight, Pointed ears and snout-like face |
